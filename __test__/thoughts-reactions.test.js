...
beforeAll(async() => {
    ...
    const url = `mongodb+srv://${DB_USER}:%24${DB_PASSWORD}%24@${DB_CLUSTER}.odgmd.mongodb.net/${DB_TEST}`
...
describe("Test Thoughts", () => {
    ...
    test("Testing Thoughts", async function() {
        ...
        expect(retUserTest.thoughts[0].thoughtText).toBe("This is a THOUGHT TEXT...");
    });
    ...
    test("Testing Thoughts: GET to get a single thought by its _id", async function() {
        ...
        expect(retRouter.thoughtText).toBe("This is a THOUGHT TEXT...");
        // console.log(jsonObj);
    });
    test("Testing Thoughts: PUT to update a thought by its _id", async function() {
        ...
        let retRouter = await router.put("/api/thoughts/:thoughtId", {
            ...
            body: {
                thoughtText: "This is a UPDATED THOUGHT TEXT..."
            }
        }, async(req) => {
        ...
        expect(retRouter.thoughtText).toBe("This is a UPDATED THOUGHT TEXT...");
        // console.log(jsonObj);
    });
...
describe("Test Reactions", () => {
    ...
    test("Testing Reactions: POST to create a reaction stored in a single thought's reactions array field", async function() {
        ...
        let retRouter = await router.post("/api/thoughts/:thoughtId/reactions", {
            ...
            body: {
                reactionBody: "This is a REACTION TEXT...",
            }
        }, async(req) => {
